...
if __name__ == '__main__':
    evaluate_site_search('./config/site-search-queries-test-set-4-cdn-exact-company-name.jsonl', './data/evaluate/site-search-results-test-set-4-cdn-exact-company-name.jsonl')
